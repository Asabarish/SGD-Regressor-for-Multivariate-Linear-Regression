...
1. Take input features (Hours, Attendance, Previous Marks) and target output (Marks Scored), then normalize the features.
2. Initialize weights and bias values with zeros.
3. Use **Stochastic Gradient Descent (SGD)** to predict output, calculate error, and update weights for many iterations.
4. Train another model using **SGDRegressor** from scikit-learn for comparison.
5. Finally, predict the marks and plot Actual vs Predicted values.
...
## Output:
<img width="1044" height="797" alt="image" src="https://github.com/user-attachments/assets/30022484-3d35-436f-9c57-3965f085295e" />
